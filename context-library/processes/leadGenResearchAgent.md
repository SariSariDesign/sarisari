...
Create a `.md` file named with the format: `YYYY-MM-DD-dailyLeadGenReport.md`
...
At the end of each week (Friday), generate a weekly summary report named with the format: `YYYY-MM-DD-weeklyLeadGenReport.md` (using the Friday date).
